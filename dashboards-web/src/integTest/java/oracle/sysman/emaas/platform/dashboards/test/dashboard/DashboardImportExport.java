...
//	@Test(dependsOnMethods = { "dashboardSetCreated" })
	...
	public void dashboardWithTileCreated()
	{
		try
		{
			String jsonString1 = "{\"type\":\"NORMAL\",\"name\":\"non_oob_dashboard\",\"showInHome\":true,\"description\":\"\","
			...
			String jsonString2 = "{\"name\":\"non_oob_dashboard\",\"enableDescription\":\"FALSE\",\"enableTimeRange\":\"TRUE\","
	...
	public void dashboardWithNonOOBTileCreated()
	{
		try
		{
			...
			String jsonString0 = "{\"name\":\"Custom_widget\",\"category\":{\"id\":2},\"folder\":{\"id\":4},\"description\":\"\",\"queryStr\":\"\",\"isWidget\":true,\"systemSearch\":false,"
		...
		//	System.out.println("#1, id is "+ res0.jsonPath().getString("id"));
			...
			String jsonString2 = "{\"name\":\"non_oob_dashboard_non_oob_tile\",\"enableDescription\":\"FALSE\",\"enableTimeRange\":\"TRUE\","
