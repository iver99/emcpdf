...
public class DashboardManagerTest extends BaseTest
{
	...
	public void testListDashboard() throws DashboardException, InterruptedException
	{
		...
		while(it.hasNext()) {
		    ...
		    if(Dashboard.DASHBOARD_TYPE_SINGLEPAGE.equals(db.getType())){
		    	it.remove();
		...
		Assert.assertEquals(allSize, originSize + 6);// dbd9/10/12 not in the returned list, as they're deleleted or from other tenants
