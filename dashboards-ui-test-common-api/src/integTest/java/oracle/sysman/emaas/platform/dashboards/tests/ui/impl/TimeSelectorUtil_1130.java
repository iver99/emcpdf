...
//		driver.getLogger().info("Option list Count:" + String.valueOf(listCount));
		for(i=1; i<=listCount; i++) {
//			driver.getLogger().info("!!!!!!!!!!!!!!!![" + i + "]Value=" + driver.getAttribute("xpath=("+ TimeSelectorUIControls.sFlexRelTimeOptList_XPATH + ")[" + i + "]@value"));
