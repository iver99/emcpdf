...
public class DashBoardPageId_1230 {
    ...
    public static final String BRANDINGBARUSERMENUITEMABOUT = "a[id= 'emcpdf_oba_about'] span[data-bind=\"text: label\"]";
    public static final String BRANDINGBARUSERMENUITEMLOGOUT = "a[id= 'emcpdf_oba_logout'] span[data-bind=\"text: label\"]";
}
